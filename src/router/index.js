...
const router = createRouter({
  ...
  routes: [
    ...
    },
    {
      ...
      component: () =>
        import("../mechanic/pages/mechanic-profile.component.vue"),
    },
    {
      path: "/appointments-customer",
      name: "appointments-customer",
      component: () =>
        import("../appointments/pages/appointments-customer.component.vue"),
    },
    {
      path: "/appointments-mechanic",
      name: "appointments-mechanic",
      component: () =>
        import("../appointments/pages/appointments-mechanic.component.vue"),
    },
    {
      path: "/customer-profile",
      name: "customer-profile",
      component: () =>
        import("../customer/pages/customer-profile.component.vue"),
    },
    {
      path: "/mechanic-admin/home",
      name: "mechanic-admin-home",
      component: () => import("../mechanic-admin/pages/home-mechanic.vue"),
    },
    {
      path: "/mechanic/editprofile",
